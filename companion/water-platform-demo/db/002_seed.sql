...
INSERT INTO asset(asset_id, asset_type, display_name, unit, geometry, elevation_m) VALUES
  ('DAM-A-PZ-07', '渗压', '案例渗压07', 'kPa',  ST_SetSRID(ST_MakePoint(113.752, 34.251, 148.2), 4490), 148.2),
  ('DAM-A-PZ-08', '渗压', '案例渗压08', 'kPa',  ST_SetSRID(ST_MakePoint(113.753, 34.251, 147.9), 4490), 147.9),
  ('DAM-A-WL-01', '库水位', '案例库水位01', 'm', ST_SetSRID(ST_MakePoint(113.750, 34.252, 152.0), 4490), 152.0),
  ('DAM-A-RG-01', '雨量', '案例雨量01', 'mm',  ST_SetSRID(ST_MakePoint(113.748, 34.253, 176.4), 4490), 176.4)
