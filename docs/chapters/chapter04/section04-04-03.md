...
<header class="platform-header">
  <div class="logo-area">
    <img src="/assets/logo.png" alt="图04.1 png">
    <h1>某流域智慧水利管理平台</h1>
  </div>
  ...
  <div class="user-controls">
    ...
    <div class="user-profile">
      <img src="/assets/avatar.jpg" alt="图04.2 jpg">
      <span>张工程师</span>
    </div>
  </div>
</header>
...
1. **控制台布局**：适用于监控中心，顶部导航+侧边栏+主内容区
   - 顶部放置全局导航、用户信息和系统通知
   - 侧边栏提供二级导航
   - 主内容区采用卡片式布局，展示关键指标和数据

2. **地图中心布局**：以地图为主体，控制面板悬浮或可折叠
   - 地图占据主要视口
   - 控制面板可折叠或悬浮在地图上
   - 功能按钮集中在地图边缘或顶部工具栏

3. **数据仪表盘布局**：多卡片网格布局，便于监控各项指标
   - 自适应网格布局
   - 卡片大小根据数据重要性和复杂度调整
   - 支持用户自定义布局和内容

4. **表单向导布局**：用于数据录入和配置向导场景
   - 步骤指示器
   - 单页聚焦单一任务
   - 清晰的前进/后退导航
