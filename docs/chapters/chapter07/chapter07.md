...
图7.6中，雨量柱从零基线向上绘制，水位线使用独立轴但共享时间索引；若为了突出“倒挂”效果将柱形向下绘制，也要在图例中说明向下方向代表降雨量而不是负值。水位预警由第8章的规则结合质量码与模型版本确定。
...
图7.9展示S5阶段页中的对象与曲线。核对场景中的选择、状态栏的对象编码及纵轴单位，可以发现“选中了一个对象，却显示另一个对象曲线”的错配。

<figure markdown>
![图7.9](images/chapter07_fig_7_9.png)
<figcaption>图 7.9  三维对象与时序曲线的联合展示（S5阶段页运行截图，显示放大）</figcaption>
</figure>
