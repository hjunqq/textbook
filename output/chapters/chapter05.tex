...
\begin{tikzpicture}[>=Stealth,thick,
  ...
  \node[error] (bad) at (3.7,-1.8) {400/422\\输入错误};
...
\begin{tikzpicture}[>=Stealth,thick,node distance=.65cm,
  ...
  \node[txbox,right=of proxy] (tx) {主事务\\保存读数};
