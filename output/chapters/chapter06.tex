...
本段涉及的字段、职责或条件见表\ref{tab:ogc-services}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:ifc-waterworks-mapping}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-five-dimensions}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-scenario-requirements}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-metadata}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:model-card}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-quality-flags}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dam-twin-scenario}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-degradation}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-observability}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-acceptance}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:dt-course-iterations}，读者可据此核对取值范围和验收依据。
\begin{table}[htbp]
\centering
\caption{常用OGC服务的职责}
...
本段所述流程或结构用图\ref{fig:uav-oblique-system}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:oblique-preprocess}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-five-dimensions}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-layered-architecture}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-evidence-chain}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-closed-loop}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-event-contract}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-edge-cloud}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:dt-lineage}具体呈现，读者可沿图中的节点和箭头检查职责边界。
\begin{figure}[H]
\centering
...
本段的误差计算按式(\ref{eq:rmse-x})核对，并把结果与坐标基准和质量阈值一起记录。
本段的误差计算按式(\ref{eq:rmse-y})核对，并把结果与坐标基准和质量阈值一起记录。
本段的误差计算按式(\ref{eq:rmse-h})核对，并把结果与坐标基准和质量阈值一起记录。
\begin{equation}
...
\]
其中$PE$为物理实体、$VE$为虚拟实体、$Ss$为服务、$DD$为孪生数据、$CN$为连接。本章沿用该五维划分，并结合水利业务对各维度作工程化细化，不把“孪生数据”改写成“数据处理”。
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-five-dimensions}核对前文的节点与边界。}
\end{figure}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-five-dimensions}核对取值与验收口径。}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-layered-architecture}核对前文的节点与边界。}
\end{figure}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-scenario-requirements}核对取值与验收口径。}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-metadata}核对取值与验收口径。}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:model-card}核对取值与验收口径。}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-quality-flags}核对取值与验收口径。}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-evidence-chain}核对前文的节点与边界。}
\end{figure}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-closed-loop}核对前文的节点与边界。}
\end{figure}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-event-contract}核对前文的节点与边界。}
\end{figure}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dam-twin-scenario}核对取值与验收口径。}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-edge-cloud}核对前文的节点与边界。}
\end{figure}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-degradation}核对取值与验收口径。}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-observability}核对取值与验收口径。}
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:dt-lineage}核对前文的节点与边界。}
\end{figure}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-acceptance}核对取值与验收口径。}
...
\textit{表中把本段的字段、条件或职责具体化，读者可结合表\ref{tab:dt-course-iterations}核对取值与验收口径。}
