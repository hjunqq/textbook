...
图\ref{fig:ch7-rain-level-combo}中，雨量柱从上方零基线向下绘制，左轴雨量随之增大；水位线读取右轴，两者共享观测时刻。向下的柱形仍表示非负雨量。水位预警由第8章的规则结合质量码与模型版本确定。
...
图\ref{fig:ch07-scene-chart}展示点击PZ-07测点后得到的同编码渗压曲线。左侧网格与垂直投影辅助识读位置，右侧显示2026年7月1日的288条观测；核对对象编码、时间范围和kPa单位可检查联动是否正确。
