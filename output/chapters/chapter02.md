...
\begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black,title=学习重点]
\begin{itemize}
\item 掌握需求获取和分析的系统方法
\item 理解水利行业需求的特殊性和复杂性
\item 熟练使用UML进行系统建模
\item 建立软件架构设计的系统思维
\end{itemize}
\end{tcolorbox}
\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black,title=常见难点]
\begin{itemize}
\item 水利专业术语和业务流程的理解
\item 功能需求与非功能需求的平衡
\item 复杂系统的建模抽象
...
| --- | --- | --- |
| 符合 | 名称 | 说明 |
| ![图02.2](images/chapter02/image11.png){width=45%} | 处理 | 能改变数据值或位置的加工。例如,程序模块、处理机等都是处理 |
| ![图02.3 符号](images/chapter02/image12.png){width=45%} | 输入/输出 | 表示输人或输出，是一个广义的不指明具体设备的符号 |
| ![图02.4 符号](images/chapter02/image13.png){width=45%} | 连接 | 指出转到图的另一部分或从图的另一部分转来,通常在同一页 |
| ![图02.5 符号](images/chapter02/image14.png){width=45%} | 换页连接 | 指出转到另一页图上或由另一页图转来 |
| ![图02.6 符号](images/chapter02/image15.png){width=45%} | 数据流 | 用来连接其他符号，指明数据流动方向 |
| ![图02.7 符号](images/chapter02/image16.png){width=45%} | 文档 | 通常表示打印输出,也可表示用打印终端输入数据 |
| ![图02.8 符号](images/chapter02/image17.png){width=45%} | 联机存储 | 表示任何种类的联机存储,包括磁盘、软盘和海量存储器件等 |
| ![图02.9 符号](images/chapter02/image18.png){width=45%} | 磁盘 | 磁盘输入/输出,也可表示存储在磁盘上的文件或数据库 |
| ![图02.10 符号](images/chapter02/image19.png){width=45%} | 显示 | CRT终端或类似的显示部件,可用于输人或输出,也可既输人又输出 |
| ![图02.11 符号](images/chapter02/image20.png){width=45%} | 人工输人 | 人工输入数据的脱机处理。例如,填写表格 |
| ![图02.12 符号](images/chapter02/image21.png){width=45%} | 人工操作 | 人工完成的处理。例如，会计在工资支票上签名 |
| ![图02.13 符号](images/chapter02/image22.png){width=45%} | 辅助操作 | 使用设备进行的脱机操作 |
| ![图02.14 符号](images/chapter02/image23.png){width=45%} | 通信链路 | 通过远程通信线路或链路传送数据 |
