...
本段涉及的字段、职责或条件见表\ref{tab:smart-water-features}，读者可据此核对取值范围和验收依据。
本段涉及的字段、职责或条件见表\ref{tab:monitoring-protocol-roles}，读者可据此核对取值范围和验收依据。
\begin{table}[htbp]
\centering
\caption{智慧水利平台的基本特征}
...
本段所述流程或结构用图\ref{fig:flood-warning-loop}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:smart-water-architecture}具体呈现，读者可沿图中的节点和箭头检查职责边界。
本段所述流程或结构用图\ref{fig:sdlc-flow}具体呈现，读者可沿图中的节点和箭头检查职责边界。
\begin{figure}[H]
\centering
...
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:smart-water-architecture}核对前文的节点与边界。}
\end{figure}
...
\label{fig:sdlc-flow}
\textit{图中把本段的流程、架构或状态关系具体化，读者可结合图\ref{fig:sdlc-flow}核对前文的节点与边界。}
\end{figure}
