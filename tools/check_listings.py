...
# (清单 label, 书稿文件, 配套文件)
PAIRS = [
    ("lst:ch07-resample-align", "output/chapters/chapter07.tex",
     "companion/water-platform-demo/frontend/src/lesson71/resample.js"),
    ("lst:ch07-quality-check", "output/chapters/chapter07.tex",
     "companion/water-platform-demo/frontend/src/lesson71/quality.js"),
    ("lst:ch07-standardize-readings", "output/chapters/chapter07.tex",
     "companion/water-platform-demo/frontend/src/lesson71/standardize.js"),
    ("lst:ch07-data-examples", "output/chapters/chapter07.tex",
     "companion/water-platform-demo/frontend/src/lesson71/examples.js"),
    ("lst:ch04-a45-request", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/api/request.js"),
    ("lst:ch04-a47-asset-api", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/api/assets.js"),
    ("lst:ch04-js-pinia", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/stores/asset.js"),
    ("lst:ch04-a47-setup-store", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/stores/asset-setup.js"),
    ("lst:ch04-a47-login", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/views/Login.vue"),
    ("lst:ch04-a47-station-detail", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/views/AssetDetail.vue"),
    ("lst:ch04-a47-store-usage", "output/chapters/chapter04.tex",
     "companion/water-platform-demo/frontend/src/views/WaterLevelSummary.vue"),
    ("lst:ch05-refresh-verifier", "output/chapters/chapter05.tex",
     "companion/water-platform-demo/backend/src/main/java/edu/example/lesson56/RefreshTokenVerifier.java"),
    ("lst:ch07-event-time-window", "output/chapters/chapter07.tex",
     "companion/water-platform-demo/frontend/src/lesson71/event-window.js"),
