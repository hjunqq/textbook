...
双指手势识别基于向量几何： - \textbf{捏合检测}：\texttt{scale_ratio = current_distance / initial_distance} - \textbf{旋转检测}：\texttt{angle_change = atan2(v2.y, v2.x) - atan2(v1.y, v1.x)} - \textbf{平移检测}：\texttt{translation = (center_current - center_initial)}
