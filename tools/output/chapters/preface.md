...
\\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Note 章节概览
    === 理论基础篇（第1-3章）
...
\\begin{tcolorbox}[colback=green!5!white,colframe=green!75!black,title=Tip 环境配置要求
    **基础环境**：
...
\\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=Note 推荐学习路径
    === 第一阶段：基础准备（1-2周）
        **目标**：掌握软件工程基础和开发环境
