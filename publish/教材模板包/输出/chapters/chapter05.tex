...
\subsection{5.1.1}\label{section-12}

\subsubsection{}\label{section-13}

\textbf{Backend Service}API''\,``\,``\,''
...
\textbf{Layered Architecture PatternSeparation of Concerns}

\textbf{Presentation LayerBusiness Logic LayerData Access
Layer}ORM\textbf{Infrastructure Layer}API
...
HTTPRESTful API**GET**HTTP********GETGETGET

**POST******POSTPOSTPOST

**PUT******DELETEPATCHHEADOPTIONS
...
**""Convention over Configuration**Spring BootRuby on Rails

****Maven/Gradlesrc/main/javasrc/main/resources****ControllerHTTPService********jarWeb

****`StationController``@RestController`Spring BootHTTPSpringHTTPJSON

****`StationService``@Service`Spring BootBean`@Transactional`

****application.ymlURLSpring BootHikariCPJPA

Spring Boot

### 

**Auto Configuration**Spring Bootclasspath**Conditional Configuration**
...
\subsection{5.2.3}\label{section-16}
...
\item
  ...
  \item
    ...
    \end{itemize}
  \item ~
    \subsection{5.2.6 Spring Boot}\label{spring-boot}
  \end{itemize}
\end{enumerate}
...
Spring Boot\textbf{GraalVM}Spring Boot****Project Reactor****Spring
Cloud
...
\subsection{5.3.1}\label{section-26}
...
\section{5.4}\label{section-28}

JDBCORM''\,``\,``\,``Spring Data JPASpringJava

\subsection{5.4.1}\label{section-29}
...
/** * RESTful API * * 1. URL * - /users /getUsers * - /users /user * -
/api/v1/users/\{id} * - URL(/api/v1) * * 2. HTTP * - GET: * - POST: * -
PUT: * - DELETE: * * 3. * - 200 OK: * - 201 Created: * - 400 Bad
Request: * - 404 Not Found: * - 500 Internal Server Error: * * 4. * -
